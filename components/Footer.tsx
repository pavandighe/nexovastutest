    ...
    <footer id="contact" className="bg-[#1e293b] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%2360a5fa' fill-opacity='0.4'%3E%3Cpath d='M20 20h-5v-5h-5v5h-5v5h5v5h5v-5h5v-5z'/%3E%3C/g%3E%3C/svg%3E")`,
        }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 bg-[#3b82f6] rounded-lg flex items-center justify-center shadow-lg">
            ...
            <div className="flex gap-3">
              <a
                href="https://wa.me/918830460132"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-gray-600/50 bg-gray-800/30 flex items-center justify-center text-white hover:border-green-400 hover:text-green-400 transition-all"
                aria-label="WhatsApp"
              >
              ...
              <a
                href="https://www.instagram.com/nexovastu"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg border border-gray-600/50 bg-gray-800/30 flex items-center justify-center text-white hover:border-pink-500 hover:text-pink-500 transition-all"
              ...
              <a
                href="https://www.facebook.com/nexovastu"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg border border-gray-600/50 bg-gray-800/30 flex items-center justify-center text-white hover:border-blue-500 hover:text-blue-500 transition-all"
                aria-label="Facebook"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.linkedin.com/company/nexovastu"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg border border-gray-600/50 bg-gray-800/30 flex items-center justify-center text-white hover:border-blue-600 hover:text-blue-600 transition-all"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Location Sites */}
          <div>
            <h3 className="font-bold text-xl mb-6 text-white">Our Location Sites</h3>
            <ul className="space-y-4">
              {LOCATION_SITES.map((site) => (
                <li key={site.name}>
                  ...
                  >
                    <div className="text-white font-medium text-sm hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+918830460132" className="text-white hover:text-gray-300 transition-colors">
                  +91 8830460132
                </a>
              </li>
              <li className="flex items-start gap-3">
